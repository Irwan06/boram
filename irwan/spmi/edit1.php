...
include 'koneksi.php';
$id = $_GET['id']; 
$query = "SELECT * FROM`spmi` where id ='$id'";
...
?> 
  <div class="content-wrapper">
    ...
    <form action="prosesedit1.php" method="post" enctype="multipart/form-data">
      <div class="container-fluid">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="username" value="<?php echo $row['password'] ?>" placeholder="Pasword" required>
                </div>
