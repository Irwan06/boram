        ...
        <!-- Small boxes (Stat box) -->
         <div class="card">
              <div class="card-header">
                <h3 class="card-title">Tabel 9.1.2.2 Prestasi Mahasiswa</h3><br>
            ...
            <div class="modal-body">
                ...
                <form action="proses12.php" method="post" enctype="multipart/form-data">
                     ...
                     <div class="form-group">
                        <td><input type="hidden" class="form-control" name="kode" value="9.1.2.2" required></td>
                    </div>
                   <div class="form-group">
                        <label for="exampleInputEmail1">Nama Mahasiswa</label>
                        <td><input type="text" class="form-control" name="tahun" placeholder="Nama Mahasiswa" required></td>
                    </div>
                  
                     <div class="form-group">
                        <label for="exampleInputEmail1">Internasional</label>
                        <td><input type="text" class="form-control" name="rata" placeholder="Internasional" required></td>
                    </div>
                     <div class="form-group">
                        <label for="exampleInputEmail1">Nasional</label>
                        <td><input type="text" class="form-control" name="maksumin" placeholder="Nasional" required></td>
                    </div>
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <td><input type="text" class="form-control" name="lulus" placeholder="Prestasi yang Dicapai" required></td>
                    </div>
                     <div class="form-group">
                        <label for="exampleInputEmail1">Waktu Pencapaian</label>
                        <td><input type="text" class="form-control" name="minimun" placeholder="Waktu Pencapaian" required></td>
                    </div>
            </div>
