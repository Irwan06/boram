        ...
        <!-- Small boxes (Stat box) -->
         <div class="card">
              <div class="card-header">
                <h3 class="card-title">Pengabdian Kepada masyarakat</h3><br>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    <td>1</td>
                    <td>Tabel 8.2.2 Aktivitas, Relevansi, dan Pelibatan Mahasiswa dalam PkM</td>
                    <td><a href="8.2.2.php?id=8.2.2">8.2.2</a> </td>
            ...
            <div class="modal-body">
                ...
                <form action="prosesupload.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <td><input type="hidden" class="form-control" name="judul" value="Pengabdian Kepada masyarakat"  required></td>
                    </div>
                     <div class="form-group">
