        ...
        <!-- Small boxes (Stat box) -->
         <div class="card">
              <div class="card-header">
                <h3 class="card-title">Tabel 6.5.2.2 Jumlah Mahasiswa Bimbingan dan Frekuensi Pertemuan</h3><br>
            ...
            <div class="modal-body">
                ...
                <form action="pro6.5.2.2.php" method="post" enctype="multipart/form-data">
                     ...
                     <div class="form-group">
                        <td><input type="hidden" class="form-control" name="kode" value="6.5.2.2" required></td>
                    </div>
                   <div class="form-group">
                        <label for="exampleInputEmail1">Nama Dosen Pembimbing Akademik</label>
                        <td><input type="text" class="form-control" name="dosen" placeholder="Nama Dosen Pembimbing Akademik" required></td>
                    </div>
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        <label for="exampleInputEmail1">Rata-Rata Banyaknya Pertemuan/ Mahasiswa/Semester</label>
                        <td><input type="text" class="form-control" name="semester" placeholder="Rata-Rata Banyaknya Pertemuan/ Mahasiswa/Semester" required></td>
                    </div>
