        ...
        <!-- Small boxes (Stat box) -->
         <div class="card">
              <div class="card-header">
                <h3 class="card-title">Tabel 4.1.2.2 DTPS yang Bidang Keahliannya Sesuai dengan Bidang PS</h3><br>
            ...
            <div class="modal-body">
                ...
                <form action="proses7.php" method="post" enctype="multipart/form-data">
                     ...
                     <div class="form-group">
                        <td><input type="hidden" class="form-control" name="kode" value="4.1.2.2" required></td>
                    </div>
                   <div class="form-group">
