        ...
        <!-- Small boxes (Stat box) -->
         <div class="card">
              <div class="card-header">
                <h3 class="card-title">Data Tabel UPPS</h3><br>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    <td>1</td>
                    <td>Tabel Data Kuantitatif di Unit Pengelola Program Studi (UPPS) - Data Program Studi</td>
                    <td><a href="upps1.php?id=UPPS-1">UPPS-1</a></td>
                  </tr>
                   <tr>
                    <td>2</td>
                    <td>Tabel Data Kuantitatif di Unit Pengelola Program Studi (UPPS) - Keuangan dan Kerjasama</td>
                    <td><a href="upps2.php?id=UPPS-2">UPPS-2</a></td>
                  </tr>
            ...
            <div class="modal-body">
                ...
                <form action="prosesupload.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <td><input type="hidden" class="form-control" name="judul" value="UPPS"  required></td>
                    </div>
                     <div class="form-group">
