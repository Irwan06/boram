              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped" border="1">
                  ...
                  <tr>
                    ...
                    <td><a href="edit3213.php?id=<?php echo $row['id'] ?>" type="button" class="btn btn-primary">Edit</a>
                    <a href="hapus322.php?id=<?php echo $row['id'] ?>" type="button" class="btn btn-danger">Hapus</a></td>
