        ...
        <!-- Small boxes (Stat box) -->
         <div class="card">
              <div class="card-header">
                <h3 class="card-title">Tabel 4.1.2.9 Bagian 1 - Pengembangan Kompetensi DTPS pada TS-2</h3><br>
            ...
            <div class="modal-body">
                ...
                <form action="proses4.1.2.9-1.php" method="post" enctype="multipart/form-data">
                     ...
                     <div class="form-group">
                        <td><input type="hidden" class="form-control" name="kode" value=" 4.1.2.9-2" required></td>
                    </div>
                   <div class="form-group">
