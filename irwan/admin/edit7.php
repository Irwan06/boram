...
include 'koneksi.php';
$id = $_GET['id']; 
$query = "SELECT * FROM`sumber` where id ='$id'";
...
?> 
  <div class="content-wrapper">
    ...
    <form action="prosesedit7.php" method="post" enctype="multipart/form-data">
      <div class="container-fluid">
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-6">
                ...
                <input type="text" class="form-control" name="jumlah" value="<?php echo $row['jumlah'] ?>"  placeholder="Vsi" required>
                </div>
                <!-- /.form-group -->
                <div class="form-group">
                 <label>Tahun</label>
                <input type="text" class="form-control" name="tahun" value="<?php echo $row['tahun'] ?>"  placeholder="tahun" required>         
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
